""" Base class for all feature extractors and matchers. 
Adapted from https://github.com/cvg/Hierarchical-Localization/blob/master/hloc/utils/base_model.py
"""
...
class BaseModel(nn.Module, metaclass=ABCMeta):
    ...
    @abstractmethod
    def _init(self, conf, *args, **kwargs):
