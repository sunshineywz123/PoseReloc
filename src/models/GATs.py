...
class GraphAttentionLayer(nn.Module):
    ...
    def forward(self, h_2d, h_3d, adj):
        ...
        e = self._prepare_attentional_mechanism_input(wh_2d, wh_3d)
    ...
    def _prepare_attentional_mechanism_input(self, wh_2d, wh_3d):
        wh_2d_ = torch.matmul(wh_2d, self.a[:self.out_features, :])
        wh_3d_ = torch.matmul(wh_3d, self.a[self.out_features:, :])

        e = wh_3d_ + wh_2d_.permute(0, 2, 1)
