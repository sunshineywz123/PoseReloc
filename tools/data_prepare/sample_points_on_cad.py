...
def parse_args():
    ...
    # parser.add_argument("--dataset_name", type=str, default="tless")
    # parser.add_argument("--obj_name", type=str, default="tless")
    parser.add_argument("--obj_path", type=str, default="/nas/users/hexingyi/bop/ycbv/models/obj_000020.ply")
    parser.add_argument("--n_sample_num", type=int, default=5000)
...
if __name__ == "__main__":
    args = parse_args()
    cat_model_path = args.obj_path
    n_sample_num = args.n_sample_num
    
    sample_3D_points = sample_points_on_cad(cat_model_path, n_sample_num, save_p3d_path="test.ply")